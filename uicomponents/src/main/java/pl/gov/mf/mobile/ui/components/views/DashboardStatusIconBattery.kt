...
class DashboardStatusIconBattery @JvmOverloads constructor(
    context: Context,
    attrs: AttributeSet? = null,
    defStyleAttr: Int = 0,
) : ConstraintLayout(context, attrs, defStyleAttr), BatteryStateInterface {
    ...
    init {
        ...
        dashboardIconDrawable.setImageDrawable(
            ResourcesCompat.getDrawable(
                resources,
                R.drawable.ic_battery_level_light,
                null
            )
        )
        dashboardIconText.text = "dashboard_indicators_battery".translate(context)
            ...
            WarningsBasicLevels.GREEN -> {
                if (darkMode)
                    Pair(
                        ...
                        R.drawable.ic_battery_level_green_dark
                    )
                else
                    Pair(
                        R.drawable.ic_dashboard_status_green_light,
                        R.drawable.ic_battery_level_green_light
                    )
            }
            WarningsBasicLevels.YELLOW -> {
                if (darkMode)
                    Pair(
                        ...
                        R.drawable.ic_battery_level_yellow_dark
                    )
                else
                    Pair(
                        R.drawable.ic_dashboard_status_yellow_light,
                        R.drawable.ic_battery_level_yellow_light
                    )
            }
            WarningsBasicLevels.RED -> {
                if (darkMode)
                    Pair(
                        ...
                        R.drawable.ic_battery_level_red_dark
                    )
                else
                    Pair(
                        R.drawable.ic_dashboard_status_red_light,
                        R.drawable.ic_battery_level_red_light
                    )
            }
            WarningsBasicLevels.UNKNOWN -> {
                if (darkMode)
                    Pair(R.drawable.ic_dashboard_status_gray_dark, R.drawable.ic_battery_level_dark)
                else
                    Pair(
                        R.drawable.ic_dashboard_status_gray_light,
                        R.drawable.ic_battery_level_light
